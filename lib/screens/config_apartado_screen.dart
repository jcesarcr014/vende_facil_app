...
void _guardarArticulos() {
  ...
  if (articulosText!.isNotEmpty) {
    ...
    apartadoProvider
      ...
      if (value.status == 1 && mounted) { // Verificar si el widget está montado
        Navigator.pop(context);
        mostrarAlerta(context, 'Guardado',
            'Artículos guardados correctamente');
      } else if (mounted) { // Verificar si el widget está montado
        mostrarAlerta(context, 'Error',
            'Error al guardar artículos: ${value.mensaje}');
      }
    });
  }
}
