  ...
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      ...
      Categoria categoria = listaCategorias.firstWhere(
          ...
          orElse: () => Categoria(id: resultados[index].idCategoria, categoria: ""));

      ColorCategoria color = listaColores.firstWhere(
          (color) => color.id == categoria.idColor,
          orElse: () => ColorCategoria(id: categoria.idColor, nombreColor: "", color: Colors.grey));
      return ListTile(
        ...
        onTap: (() {
          if (resultados[index].unidad == "0") {
            ...
            // Otra lógica de acción al hacer clic
          }
        }),
        title: Row(
